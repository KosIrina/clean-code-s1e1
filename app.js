...
var createNewTaskElement=function(taskString){
    ...
    //label
    var itemName=document.createElement("p");//task content
    //input (text)
    ...
    itemName.innerText=taskString;
    itemName.className='tasks__text-content';
...
var editTask=function(){
    ...
    var itemName=listItem.querySelector(".tasks__text-content");
    ...
    if(containsClass){
        ...
        editInput.value=itemName.innerText;
